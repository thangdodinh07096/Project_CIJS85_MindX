                        ...
                        <div className="offcanvas offcanvas-end text-bg-dark" tabIndex={-1} id="offcanvasDarkNavbar" aria-labelledby="offcanvasDarkNavbarLabel">
                            ...
                            <div className="offcanvas-body">
                                <ul className="navbar-nav justify-content-end flex-grow-1 pe-3">
                                    ...
                                    <li className="nav-item">
                                        <NavLink to="/hotels" className={activeClass}>BOOKING</NavLink>
                                        {/* <a className="nav-link" href="./rooms.html">ROOMS</a> */}
                                    </li>
                                    <li className="nav-item">
                                        <NavLink to="/about-us" className={activeClass}>ABOUT US</NavLink>
                                        {/* <a className="nav-link" href="./rooms.html">ROOMS</a> */}
                                    </li><li className="nav-item">
                                        <NavLink to="/blogs" className={activeClass}>BLOG</NavLink>
                                        {/* <a className="nav-link" href="./rooms.html">ROOMS</a> */}
                                    </li><li className="nav-item">
