            ...
            <div className="row g-0 item">
                ...
                <div className="col-md-7">
                    <div className="card-body m-1">
                        ...
                        <h5 className='address'><i class="fas fa-map-marker-alt" style={{ color: "#4d67ce" }}></i> {buildingNumber}, {street}, {district}, {city}</h5>
                                    ...
                                    mainUtiLities.map((mainUtiLitiesItem) => {
                                        return (
                                            <div class="room-options col-6">
                                                <div className='row'>
                                                    <img src={mainUtiLitiesItem.mainUtiLitiesImg} className="col-3" alt="..." />
                                                    <div className="col-9" style={{ fontWeight: "550", fontSize: "15px", lineHeight: "30px" }}>
