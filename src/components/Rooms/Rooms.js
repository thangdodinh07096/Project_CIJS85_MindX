    ...
    <div id="find-rooms">
      ...
      <div className="container">
        <div className="row">
            ...
            <div className="list-group">
              ...
              <div className="form-check">
                <input
                  className="form-check-input  filter-radio"
                  type="radio"
                  onclick="filterHasFreeCancellation()"
                  name="flexRadioDefault"
              ...
              <div className="form-check">
                <input
                  className="form-check-input  filter-radio"
                  type="radio"
                  onclick="filterIncludesBreakfast()"
                  name="flexRadioDefault"
              ...
              <div className="form-check">
                <input
                  className="form-check-input  filter-radio"
                  type="radio"
                  onclick="filterHasFitnessCenter()"
                  name="flexRadioDefault"
                  id="hasFitnessCenter"
                />
          ...
          <div id="list-room" className="col-8"></div>
